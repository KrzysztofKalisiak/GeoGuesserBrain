...
def system_loader(SYSTEM_ID, force_override=False):
    ...
    if 'data_location' in system_conf:
        data_location = system_conf['data_location']
    else:
    ...
    print('model loaded')
    train_dataset, test_dataset, pct_n, mapping, shp_n, pct, shp, countries = process_data(premerged_shapes, SYSTEM_ID, system_conf['on_embeddings'], preprocess, data_location)
